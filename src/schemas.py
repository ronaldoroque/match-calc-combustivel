...
class Coordenadas(BaseModel):
    ...
    @validator('origem_longitude', 'origem_latitude', 'destino_longitude', 'destino_latitude')
...
class Route(BaseModel):
    ...
    distance: float
    legs: list[Leg]
    geometry: Union[str, dict[str, Union[list[list[float]], str]]]
